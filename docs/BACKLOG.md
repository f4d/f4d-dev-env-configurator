...
### A22 — `verify.sh` printed "skipped, need BASE_REF" even when BASE_REF was set · ✅ built in 1.23.2
...
command/output pairs: `docs/acceptance/2026-08-13-a22-verify-sh-base-ref-gates.md`.
...
**Files:** `scripts/verify.sh`, `docs/acceptance/2026-08-13-a22-verify-sh-base-ref-gates.md`
